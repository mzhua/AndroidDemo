...
public class ShowTipsBuilder {
    ...
    public ShowTipsBuilder setButtonText(String text){
        showtipsView.setButtonText(text);
        return this;
    }

    public ShowTipsBuilder setButtonBgColor(int color){
        showtipsView.setBtnColor(color);
        return this;
    }

    public ShowTipsBuilder setShape(int shape){
        showtipsView.setShape(shape);
        return this;
    }
}
